/*
 *	autogen/server/zone/managers/auction/AuctionManager.cpp generated by engine3 IDL compiler 0.70
 */
...
void AuctionManager::getData(CreatureObject* player, int locationType, unsigned long long vendorObjectID, int searchType, unsigned int itemCategory, const UnicodeString& filterText, int minPrice, int maxPrice, bool includeEntranceFee, int count, int offset) {
	AuctionManagerImplementation* _implementation = static_cast<AuctionManagerImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == nullptr)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_GETDATA__CREATUREOBJECT_INT_LONG_INT_INT_UNICODESTRING_INT_INT_BOOL_INT_INT_);
		method.addObjectParameter(player);
		method.addSignedIntParameter(locationType);
		method.addUnsignedLongParameter(vendorObjectID);
		method.addSignedIntParameter(searchType);
		method.addUnsignedIntParameter(itemCategory);
		method.addUnicodeParameter(filterText);
		method.addSignedIntParameter(minPrice);
		method.addSignedIntParameter(maxPrice);
		method.addBooleanParameter(includeEntranceFee);
		method.addSignedIntParameter(count);
		method.addSignedIntParameter(offset);

		method.executeWithVoidReturn();
	} else {
		_implementation->getData(player, locationType, vendorObjectID, searchType, itemCategory, filterText, minPrice, maxPrice, includeEntranceFee, count, offset);
	}
}

void AuctionManager::getAuctionData(CreatureObject* player, SceneObject* usedVendor, const String& planet, const String& region, SceneObject* vendor, int screen, unsigned int category, const UnicodeString& filterText, int minPrice, int maxPrice, bool includeEntranceFee, int count, int offset) {
	AuctionManagerImplementation* _implementation = static_cast<AuctionManagerImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == nullptr)) {
		throw ObjectNotLocalException(this);

	} else {
		_implementation->getAuctionData(player, usedVendor, planet, region, vendor, screen, category, filterText, minPrice, maxPrice, includeEntranceFee, count, offset);
	}
}
...
AuctionQueryHeadersResponseMessage* AuctionManager::fillAuctionQueryHeadersResponseMessage(CreatureObject* player, SceneObject* vendor, TerminalListVector* terminalList, int screen, unsigned int category, const UnicodeString& filterText, int minPrice, int maxPrice, bool includeEntranceFee, int count, int offset) {
	AuctionManagerImplementation* _implementation = static_cast<AuctionManagerImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == nullptr)) {
		throw ObjectNotLocalException(this);

	} else {
		return _implementation->fillAuctionQueryHeadersResponseMessage(player, vendor, terminalList, screen, category, filterText, minPrice, maxPrice, includeEntranceFee, count, offset);
	}
}
...
void AuctionManager::checkVendorItems(bool startupTask) {
	AuctionManagerImplementation* _implementation = static_cast<AuctionManagerImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == nullptr)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_CHECKVENDORITEMS__BOOL_);
		method.addBooleanParameter(startupTask);

		method.executeWithVoidReturn();
	} else {
		_implementation->checkVendorItems(startupTask);
	}
}

void AuctionManager::checkAuctions(bool startupTask) {
	AuctionManagerImplementation* _implementation = static_cast<AuctionManagerImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == nullptr)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_CHECKAUCTIONS__BOOL_);
		method.addBooleanParameter(startupTask);

		method.executeWithVoidReturn();
	} else {
		_implementation->checkAuctions(startupTask);
	}
}
...
AuctionManagerImplementation::AuctionManagerImplementation(ZoneServer* server) {
	...
	(&auctionEvents)->setNullValue(nullptr);
}
...
void AuctionManagerAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_GETITEMATTRIBUTES__CREATUREOBJECT_LONG_:
		...
		break;
	case RPC_GETDATA__CREATUREOBJECT_INT_LONG_INT_INT_UNICODESTRING_INT_INT_BOOL_INT_INT_:
		{
			CreatureObject* player = static_cast<CreatureObject*>(inv->getObjectParameter());
			int locationType = inv->getSignedIntParameter();
			unsigned long long vendorObjectID = inv->getUnsignedLongParameter();
			int searchType = inv->getSignedIntParameter();
			unsigned int itemCategory = inv->getUnsignedIntParameter();
			 UnicodeString filterText; inv->getUnicodeParameter(filterText);
			int minPrice = inv->getSignedIntParameter();
			int maxPrice = inv->getSignedIntParameter();
			bool includeEntranceFee = inv->getBooleanParameter();
			int count = inv->getSignedIntParameter();
			int offset = inv->getSignedIntParameter();
			
			getData(player, locationType, vendorObjectID, searchType, itemCategory, filterText, minPrice, maxPrice, includeEntranceFee, count, offset);
	...
	case RPC_GETAUCTIONMAP__:
		...
		break;
	case RPC_CHECKVENDORITEMS__BOOL_:
		{
			bool startupTask = inv->getBooleanParameter();
			
			checkVendorItems(startupTask);
			
		}
		break;
	case RPC_CHECKAUCTIONS__BOOL_:
		{
			bool startupTask = inv->getBooleanParameter();
			
			checkAuctions(startupTask);
...
void AuctionManagerAdapter::getData(CreatureObject* player, int locationType, unsigned long long vendorObjectID, int searchType, unsigned int itemCategory, const UnicodeString& filterText, int minPrice, int maxPrice, bool includeEntranceFee, int count, int offset) {
	(static_cast<AuctionManager*>(stub))->getData(player, locationType, vendorObjectID, searchType, itemCategory, filterText, minPrice, maxPrice, includeEntranceFee, count, offset);
}
...
void AuctionManagerAdapter::checkVendorItems(bool startupTask) {
	(static_cast<AuctionManager*>(stub))->checkVendorItems(startupTask);
}

void AuctionManagerAdapter::checkAuctions(bool startupTask) {
	(static_cast<AuctionManager*>(stub))->checkAuctions(startupTask);
}
...
DistributedObjectPOD* AuctionManagerHelper::instantiatePOD() {
	return new AuctionManagerPOD();
}
...
AuctionManagerPOD::~AuctionManagerPOD() {
}

AuctionManagerPOD::AuctionManagerPOD(void) {
	_className = "AuctionManager";
}


void AuctionManagerPOD::writeObject(ObjectOutputStream* stream) {
	int _currentOffset = stream->getOffset();
	stream->writeShort(0);
	int _varCount = AuctionManagerPOD::writeObjectMembers(stream);
	stream->writeShort(_currentOffset, _varCount);
}

int AuctionManagerPOD::writeObjectMembers(ObjectOutputStream* stream) {
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<ManagedReference<AuctionsMapPOD* > >::toBinaryStream(&auctionMap.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<AuctionEventsMap >::toBinaryStream(&auctionEvents.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}

	if (pendingUIDUpdates) {
	_nameHashCode = 0xd9368eaf; //AuctionManager.pendingUIDUpdates
	TypeInfo<uint32>::toBinaryStream(&_nameHashCode, stream);
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<VectorMap<ManagedReference<SceneObjectPOD* >, String> >::toBinaryStream(&pendingUIDUpdates.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}

	if (pendingOldUIDUpdates) {
	_nameHashCode = 0x4ea2c561; //AuctionManager.pendingOldUIDUpdates
	TypeInfo<uint32>::toBinaryStream(&_nameHashCode, stream);
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<VectorMap<ManagedReference<SceneObjectPOD* >, String> >::toBinaryStream(&pendingOldUIDUpdates.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<bool >::toBinaryStream(&marketEnabled.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
...
bool AuctionManagerPOD::readObjectMember(ObjectInputStream* stream, const uint32& nameHashCode) {
	...
	case 0x6447c3cf: //AuctionManager.auctionMap
		{
			ManagedReference<AuctionsMapPOD* > _mnauctionMap;
			TypeInfo<ManagedReference<AuctionsMapPOD* > >::parseFromBinaryStream(&_mnauctionMap, stream);
			auctionMap = std::move(_mnauctionMap);
		}
		return true;
	...
	case 0x83357598: //AuctionManager.auctionEvents
		{
			AuctionEventsMap _mnauctionEvents;
			TypeInfo<AuctionEventsMap >::parseFromBinaryStream(&_mnauctionEvents, stream);
			auctionEvents = std::move(_mnauctionEvents);
		}
		return true;

	case 0xd9368eaf: //AuctionManager.pendingUIDUpdates
		{
			VectorMap<ManagedReference<SceneObjectPOD* >, String> _mnpendingUIDUpdates;
			TypeInfo<VectorMap<ManagedReference<SceneObjectPOD* >, String> >::parseFromBinaryStream(&_mnpendingUIDUpdates, stream);
			pendingUIDUpdates = std::move(_mnpendingUIDUpdates);
		}
		return true;

	case 0x4ea2c561: //AuctionManager.pendingOldUIDUpdates
		{
			VectorMap<ManagedReference<SceneObjectPOD* >, String> _mnpendingOldUIDUpdates;
			TypeInfo<VectorMap<ManagedReference<SceneObjectPOD* >, String> >::parseFromBinaryStream(&_mnpendingOldUIDUpdates, stream);
			pendingOldUIDUpdates = std::move(_mnpendingOldUIDUpdates);
		}
		return true;

	case 0x2518ce00: //AuctionManager.marketEnabled
		{
			bool _mnmarketEnabled;
			TypeInfo<bool >::parseFromBinaryStream(&_mnmarketEnabled, stream);
			marketEnabled = std::move(_mnmarketEnabled);
		}
		return true;
...
void AuctionManagerPOD::readObject(ObjectInputStream* stream) {
	uint16 _varCount = stream->readShort();
	for (int i = 0; i < _varCount; ++i) {
		uint32 _nameHashCode;
		TypeInfo<uint32>::parseFromBinaryStream(&_nameHashCode, stream);
		...
		if(AuctionManagerPOD::readObjectMember(stream, _nameHashCode)) {
		}
...
void AuctionManagerPOD::writeObjectCompact(ObjectOutputStream* stream) {
