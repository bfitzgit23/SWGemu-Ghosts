/*
 *	autogen/server/zone/managers/minigames/ForageManager.h generated by engine3 IDL compiler 0.70
 */
...
class ForageManagerPOD : public ObserverPOD {
public:
	Optional<ForageMap> forageAreas;
