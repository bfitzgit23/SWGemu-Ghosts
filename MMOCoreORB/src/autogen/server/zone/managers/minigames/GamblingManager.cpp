/*
 *	autogen/server/zone/managers/minigames/GamblingManager.cpp generated by engine3 IDL compiler 0.70
 */
...
enum {RPC_INITIALIZESLOTTIMER__,RPC_INITIALIZEROULETTETIMER__,RPC_INITIALIZESLOTSWINNINGS__,RPC_INITIALIZEROULETTERED__,RPC_INITIALIZEROULETTE__,RPC_NOTIFY__SCENEOBJECT_,RPC_ISHIGH__INT_,RPC_ISLOW__INT_,RPC_ISEVEN__INT_,RPC_ISODD__INT_,RPC_ISBLACK__INT_,RPC_ISRED__INT_,RPC_REMOVEOUTOFRANGEPLAYERS__GAMBLINGTERMINAL_,RPC_HANDLESLOT__CREATUREOBJECT_BOOL_BOOL_,RPC_BETTINGALLOWED__CREATUREOBJECT_,RPC_GETMAXIMUMALLOWEDBET__GAMBLINGTERMINAL_CREATUREOBJECT_INT_,RPC_BET__CREATUREOBJECT_INT_INT_INT_,RPC_BET__GAMBLINGTERMINAL_CREATUREOBJECT_INT_INT_,RPC_CREATEGAMBLINGEVENT__GAMBLINGTERMINAL_INT_,RPC_STARTGAME__CREATUREOBJECT_INT_,RPC_STARTGAME__GAMBLINGTERMINAL_,RPC_LEAVETERMINAL__CREATUREOBJECT_INT_,RPC_REGISTERPLAYER__GAMBLINGTERMINAL_CREATUREOBJECT_,RPC_REFRESHROULETTEMENU__CREATUREOBJECT_,RPC_CONTINUEGAME__GAMBLINGTERMINAL_,RPC_STOPGAME__GAMBLINGTERMINAL_BOOL_,RPC_CALCULATEOUTCOME__GAMBLINGTERMINAL_,RPC_CREATEWINDOW__GAMBLINGTERMINAL_CREATUREOBJECT_,RPC_CREATEPAYOUTWINDOW__CREATUREOBJECT_,RPC_CREATESLOTWINDOW__CREATUREOBJECT_INT_,RPC_CREATEROULETTEWINDOW__CREATUREOBJECT_,RPC_ISPLAYING__CREATUREOBJECT_,RPC_REMOVEGAMBLER__CREATUREOBJECT_INT_};
...
void GamblingManager::createGamblingEvent(GamblingTerminal* terminal, unsigned int time) {
	GamblingManagerImplementation* _implementation = static_cast<GamblingManagerImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_CREATEGAMBLINGEVENT__GAMBLINGTERMINAL_INT_);
		method.addObjectParameter(terminal);
		method.addUnsignedIntParameter(time);

		method.executeWithVoidReturn();
	} else {
		_implementation->createGamblingEvent(terminal, time);
	}
}
...
void GamblingManager::stopGame(GamblingTerminal* terminal, bool cancel) {
	...
	if (unlikely(_implementation == NULL)) {
		...
		assert((terminal == NULL) || terminal->isLockedByCurrentThread());
...
void GamblingManager::removeGambler(CreatureObject* player, int machineType) {
	GamblingManagerImplementation* _implementation = static_cast<GamblingManagerImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_REMOVEGAMBLER__CREATUREOBJECT_INT_);
		method.addObjectParameter(player);
		method.addSignedIntParameter(machineType);

		method.executeWithVoidReturn();
	} else {
		_implementation->removeGambler(player, machineType);
	}
}
...
DistributedObjectServant* GamblingManager::_getImplementationForRead() const {
	return _impl;
}
...
void GamblingManagerAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_HANDLESLOT__CREATUREOBJECT_BOOL_BOOL_:
		{
			...
			bool cancel = inv->getBooleanParameter();
			bool other = inv->getBooleanParameter();
	...
	case RPC_BET__CREATUREOBJECT_INT_INT_INT_:
		{
			...
			int target = inv->getSignedIntParameter();
			int machineType = inv->getSignedIntParameter();
			
			bet(player, amount, target, machineType);
	...
	case RPC_BET__GAMBLINGTERMINAL_CREATUREOBJECT_INT_INT_:
		{
			...
			bet(terminal, player, amount, target);
			
		}
		break;
	case RPC_CREATEGAMBLINGEVENT__GAMBLINGTERMINAL_INT_:
		{
			GamblingTerminal* terminal = static_cast<GamblingTerminal*>(inv->getObjectParameter());
	...
	case RPC_LEAVETERMINAL__CREATUREOBJECT_INT_:
		{
			...
			leaveTerminal(player, machineType);
	...
	case RPC_REGISTERPLAYER__GAMBLINGTERMINAL_CREATUREOBJECT_:
		{
			...
			registerPlayer(terminal, player);
	...
	case RPC_CREATEWINDOW__GAMBLINGTERMINAL_CREATUREOBJECT_:
		{
			...
			unsigned int _m_res = createWindow(terminal, player);
	...
	case RPC_CREATEPAYOUTWINDOW__CREATUREOBJECT_:
		{
			...
			unsigned int _m_res = createPayoutWindow(player);
			resp->insertInt(_m_res);
		}
		break;
	case RPC_CREATESLOTWINDOW__CREATUREOBJECT_INT_:
		{
			CreatureObject* player = static_cast<CreatureObject*>(inv->getObjectParameter());
			unsigned int payoutBoxID = inv->getUnsignedIntParameter();
			
			unsigned int _m_res = createSlotWindow(player, payoutBoxID);
			resp->insertInt(_m_res);
		}
		break;
	case RPC_CREATEROULETTEWINDOW__CREATUREOBJECT_:
		{
			...
			unsigned int _m_res = createRouletteWindow(player);
			resp->insertInt(_m_res);
		}
		break;
	case RPC_ISPLAYING__CREATUREOBJECT_:
		...
		break;
	case RPC_REMOVEGAMBLER__CREATUREOBJECT_INT_:
		{
			CreatureObject* player = static_cast<CreatureObject*>(inv->getObjectParameter());
			int machineType = inv->getSignedIntParameter();
			
			removeGambler(player, machineType);
...
void GamblingManagerAdapter::createGamblingEvent(GamblingTerminal* terminal, unsigned int time) {
	(static_cast<GamblingManager*>(stub))->createGamblingEvent(terminal, time);
}
...
void GamblingManagerAdapter::removeGambler(CreatureObject* player, int machineType) {
	(static_cast<GamblingManager*>(stub))->removeGambler(player, machineType);
}
...
DistributedObjectPOD* GamblingManagerHelper::instantiatePOD() {
	return new GamblingManagerPOD();
}
...
GamblingManagerPOD::~GamblingManagerPOD() {
}

GamblingManagerPOD::GamblingManagerPOD(void) {
	_className = "GamblingManager";
}


void GamblingManagerPOD::writeObject(ObjectOutputStream* stream) {
	int _currentOffset = stream->getOffset();
	stream->writeShort(0);
	int _varCount = GamblingManagerPOD::writeObjectMembers(stream);
	stream->writeShort(_currentOffset, _varCount);
}

int GamblingManagerPOD::writeObjectMembers(ObjectOutputStream* stream) {
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > > >::toBinaryStream(&slotGames.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > > >::toBinaryStream(&rouletteGames.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<Vector<String> >::toBinaryStream(&roulette.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<Vector<String> >::toBinaryStream(&red.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
	...
	_offset = stream->getOffset();
	stream->writeInt(0);
	TypeInfo<Vector<int> >::toBinaryStream(&slot.value(), stream);
	_totalSize = (uint32) (stream->getOffset() - (_offset + 4));
	stream->writeInt(_offset, _totalSize);
	_count++;
	}
...
bool GamblingManagerPOD::readObjectMember(ObjectInputStream* stream, const uint32& nameHashCode) {
	...
	case 0x5b7d0ed3: //GamblingManager.slotGames
		{
			VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > > _mnslotGames;
			TypeInfo<VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > > >::parseFromBinaryStream(&_mnslotGames, stream);
			slotGames = std::move(_mnslotGames);
		}
		return true;

	case 0x7d3f71b4: //GamblingManager.rouletteGames
		{
			VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > > _mnrouletteGames;
			TypeInfo<VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > > >::parseFromBinaryStream(&_mnrouletteGames, stream);
			rouletteGames = std::move(_mnrouletteGames);
		}
		return true;

	case 0xe9591d2: //GamblingManager.roulette
		{
			Vector<String> _mnroulette;
			TypeInfo<Vector<String> >::parseFromBinaryStream(&_mnroulette, stream);
			roulette = std::move(_mnroulette);
		}
		return true;

	case 0x658e5977: //GamblingManager.red
		{
			Vector<String> _mnred;
			TypeInfo<Vector<String> >::parseFromBinaryStream(&_mnred, stream);
			red = std::move(_mnred);
		}
		return true;
	...
	case 0x5cadbf05: //GamblingManager.slot
		{
			Vector<int> _mnslot;
			TypeInfo<Vector<int> >::parseFromBinaryStream(&_mnslot, stream);
	...
	case 0xfe932df5: //GamblingManager.slotTimer
		{
			Vector<int> _mnslotTimer;
			TypeInfo<Vector<int> >::parseFromBinaryStream(&_mnslotTimer, stream);
			slotTimer = std::move(_mnslotTimer);
		}
		return true;

	case 0xd8d15292: //GamblingManager.rouletteTimer
		{
			Vector<int> _mnrouletteTimer;
			TypeInfo<Vector<int> >::parseFromBinaryStream(&_mnrouletteTimer, stream);
			rouletteTimer = std::move(_mnrouletteTimer);
		}
		return true;
...
void GamblingManagerPOD::readObject(ObjectInputStream* stream) {
	uint16 _varCount = stream->readShort();
	for (int i = 0; i < _varCount; ++i) {
		uint32 _nameHashCode;
		TypeInfo<uint32>::parseFromBinaryStream(&_nameHashCode, stream);
		...
		if(GamblingManagerPOD::readObjectMember(stream, _nameHashCode)) {
		}
...
void GamblingManagerPOD::writeObjectCompact(ObjectOutputStream* stream) {
