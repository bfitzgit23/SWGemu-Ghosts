/*
 *	autogen/server/zone/managers/minigames/GamblingManager.h generated by engine3 IDL compiler 0.70
 */
...
public:
	 ...
	 */
	void createGamblingEvent(GamblingTerminal* terminal, unsigned int time);
	...
	void removeGambler(CreatureObject* player, int machineType);
...
class GamblingManagerPOD : public ObserverPOD {
public:
	Optional<VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > >> slotGames;

	Optional<VectorMap<ManagedReference<CreatureObjectPOD* >, ManagedReference<GamblingTerminalPOD* > >> rouletteGames;

	Optional<Vector<String>> roulette;

	Optional<Vector<String>> red;

	Optional<Vector<int>> slot;
