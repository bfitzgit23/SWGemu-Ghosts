/*
 *	autogen/server/zone/objects/creature/conversation/ConversationObserver.h generated by engine3 IDL compiler 0.70
 */
...
class ConversationObserverPOD : public ObserverPOD {
public:
	Optional<unsigned int> conversationTemplateCRC;

	Optional<VectorMap<String, ScreenHandler*>> screenHandlers;
	...
	virtual ~ConversationObserverPOD();
...
#endif /*CONVERSATIONOBSERVERPOD_H_*/
