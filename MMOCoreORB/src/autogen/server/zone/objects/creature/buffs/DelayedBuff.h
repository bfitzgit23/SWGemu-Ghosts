/*
 *	autogen/server/zone/objects/creature/buffs/DelayedBuff.h generated by engine3 IDL compiler 0.70
 */
...
class DelayedBuffPOD : public BuffPOD {
public:
