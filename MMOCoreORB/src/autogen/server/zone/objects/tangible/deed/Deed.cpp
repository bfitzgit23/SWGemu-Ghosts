...
String DeedImplementation::getGeneratedObjectTemplate() const{
...
bool DeedImplementation::isGenerated() const{
...
String DeedAdapter::getGeneratedObjectTemplate() const {
...
bool DeedAdapter::isGenerated() const {
