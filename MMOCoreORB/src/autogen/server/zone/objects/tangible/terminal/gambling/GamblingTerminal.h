/*
 *	autogen/server/zone/objects/tangible/terminal/gambling/GamblingTerminal.h generated by engine3 IDL compiler 0.70
 */
...
public:
	...
	Vector<Reference<GamblingBet*> >* getBets();
...
protected:
	...
	Vector<Reference<GamblingBet*> > bets;
...
class GamblingTerminalPOD : public TerminalPOD {
public:
