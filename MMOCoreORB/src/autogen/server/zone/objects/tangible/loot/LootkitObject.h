/*
 *	autogen/server/zone/objects/tangible/loot/LootkitObject.h generated by engine3 IDL compiler 0.70
 */
...
class LootkitObjectPOD : public TangibleObjectPOD {
public:
	Optional<VectorMap<unsigned int, bool>> components;

	Optional<VectorMap<unsigned int, String>> attributes;

	Optional<Vector<unsigned int>> comps;

	Optional<Vector<unsigned int>> reward;

	Optional<bool> deleteComponents;
