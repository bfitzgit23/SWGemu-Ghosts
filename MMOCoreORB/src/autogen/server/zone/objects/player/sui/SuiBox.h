/*
 *	autogen/server/zone/objects/player/sui/SuiBox.h generated by engine3 IDL compiler 0.70
 */
...
class SuiBoxPOD : public ManagedObjectPOD {
public:
	Optional<ManagedWeakReference<CreatureObjectPOD* >> player;

	Optional<Reference<SuiCallback* >> suiCallback;
	...
	Optional<String> cancelButtonText;

	Optional<bool> cancelButton;

	Optional<String> okButtonText;

	Optional<bool> okButton;

	Optional<String> otherButtonText;

	Optional<bool> otherButton;

	Optional<String> promptTitle;

	Optional<String> promptText;

	Optional<int> boxType;

	Optional<unsigned int> windowType;

	Optional<float> forceCloseDistance;

	Optional<Vector<String>> headerSets;

	Optional<Vector<String>> optionSets;

	Optional<int> hdrOptCount;

	Optional<bool> hasGenerated;
