/*
 *	autogen/server/zone/objects/ship/FighterShipObject.h generated by engine3 IDL compiler 0.70
 */
...
class FighterShipObjectPOD : public ShipObjectPOD {
public:
