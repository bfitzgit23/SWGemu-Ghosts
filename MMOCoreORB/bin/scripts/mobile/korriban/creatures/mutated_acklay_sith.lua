mutated_acklay_sith = Creature:new {
	objectName = "",
	customName = "<< Mutated Sith Acklay >>",
	socialGroup = "sith",
	faction = "",
	level = 320,
	chanceHit = 35.0,
	...
	templates = {"object/mobile/beast_master/shared_bm_mutated_acklay_sith.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(mutated_acklay_sith, "mutated_acklay_sith")
