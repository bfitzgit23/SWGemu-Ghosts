korriban_bunker_protocol_droid = ConvoTemplate:new {
  initialScreen = "korriban_bunker_protocol_droid_start",
  templateType = "Lua",
  luaClassHandler = "korriban_bunker_protocol_droid_convo_handler",
  screens = {}
}


--Intro First
korriban_bunker_protocol_droid_start = ConvoScreen:new {
  id = "korriban_bunker_protocol_droid_start",
  leftDialog = "",
...
korriban_bunker_protocol_droid:addScreen(korriban_bunker_protocol_droid_start);
...
korriban_bunker_protocol_droid:addScreen(deny1);
...
korriban_bunker_protocol_droid:addScreen(opt1);
...
korriban_bunker_protocol_droid:addScreen(opt1a);
...
korriban_bunker_protocol_droid:addScreen(opt1b);
...
korriban_bunker_protocol_droid:addScreen(opt1c);

addConversationTemplate("korriban_bunker_protocol_droid", korriban_bunker_protocol_droid);
