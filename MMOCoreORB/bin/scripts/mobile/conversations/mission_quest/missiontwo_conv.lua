missiontwo_quest_template = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "missiontwo_quest_convo_handler",
	screens = {}
}


missiontwo_start_quest = ConvoScreen:new {
	id = "start",
...
missiontwo_quest_template:addScreen(missiontwo_start_quest);
-----------------

missiontwo_intro = ConvoScreen:new {
	id = "intro",
...
missiontwo_quest_template:addScreen(missiontwo_intro);
-----------------
--------------------

missiontwo_intro2 = ConvoScreen:new {
	id = "intro2",
...
missiontwo_quest_template:addScreen(missiontwo_intro2);

-------------

missiontwo_intro3 = ConvoScreen:new {
	id = "intro3",
...
missiontwo_quest_template:addScreen(missiontwo_intro3);
-------------

missiontwo_intro4 = ConvoScreen:new {
	id = "intro4",
...
missiontwo_quest_template:addScreen(missiontwo_intro4);
----------------

missiontwo_intro5 = ConvoScreen:new {
  id = "intro5",
...
missiontwo_quest_template:addScreen(missiontwo_intro5);
----------------


missiontwo_intro6 = ConvoScreen:new {
  id = "intro6",
...
missiontwo_quest_template:addScreen(missiontwo_intro6);

missiontwo_intro7 = ConvoScreen:new {
  id = "intro7",
...
missiontwo_quest_template:addScreen(missiontwo_intro7);

missiontwo_intro8 = ConvoScreen:new {
  id = "intro8",
...
missiontwo_quest_template:addScreen(missiontwo_intro8);

missiontwo_bye = ConvoScreen:new {
  id = "bye",
  customDialogText = "Goodbye.",
  stopConversation = "true",
  options = {}
}
missiontwo_quest_template:addScreen(missiontwo_bye);

missiontwo_bye2 = ConvoScreen:new {
  id = "bye2",
  customDialogText = "Luck.",
  stopConversation = "true",
  options = {}
}
missiontwo_quest_template:addScreen(missiontwo_bye2);

missiontwo_bye3 = ConvoScreen:new {
  id = "bye3",
  customDialogText = "Come back if you change your mind.",
  stopConversation = "true",
  options = {}
}
missiontwo_quest_template:addScreen(missiontwo_bye3);

missiontwo_quest_accept_quest = ConvoScreen:new {
	id = "accept_quest",
	customDialogText = "Good luck. And may the Force guide you.",
	stopConversation = "true",
	options = {}
}
missiontwo_quest_template:addScreen(missiontwo_quest_accept_quest);

missiontwo_quest_quest_status = ConvoScreen:new {
	id = "quest_status",
	customDialogText = "",
	stopConversation = "true",
	options = {}
}
missiontwo_quest_template:addScreen(missiontwo_quest_quest_status);

missiontwo_quest_not_yet= ConvoScreen:new {
	id = "not_yet",
...
missiontwo_quest_template:addScreen(missiontwo_quest_not_yet);

missiontwo_quest_thank_you = ConvoScreen:new {
	id = "thank_you",
	customDialogText = "I will remember what you have done for me. Keep this present as a token of my sincere gratitude.",
	stopConversation = "true",
	options = {}
}
missiontwo_quest_template:addScreen(missiontwo_quest_thank_you);

missiontwo_quest_completed = ConvoScreen:new {
	id = "completed",
	customDialogText = "I feel that you managed to defeat Darth Caedus! You came to my brother ...",
	stopConversation = "true",
	options = {}
}
missiontwo_quest_template:addScreen(missiontwo_quest_completed);

missiontwo_quest_reset = ConvoScreen:new {
	id = "quest_reset",
	customDialogText = "Come back if you change your mind ...",
	stopConversation = "true",
	options = {}
}
missiontwo_quest_template:addScreen(missiontwo_quest_reset);

----- There is no place in the inventory to give the reward ---
missiontwo_no_space = ConvoScreen:new {
  id = "no_space",
  customDialogText = "It seems as if you have to make room in your inventory before receiving your reward.",
  stopConversation = "true",
  options = {}
}
missiontwo_quest_template:addScreen(missiontwo_no_space);

addConversationTemplate("missiontwo_quest_template", missiontwo_quest_template);
