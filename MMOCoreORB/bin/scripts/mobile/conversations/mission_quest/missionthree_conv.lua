missionthree_quest_template = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "missionthree_quest_convo_handler",
	screens = {}
}


missionthree_start_quest = ConvoScreen:new {
	id = "start",
...
missionthree_quest_template:addScreen(missionthree_start_quest);
-----------------

missionthree_intro = ConvoScreen:new {
	id = "intro",
...
missionthree_quest_template:addScreen(missionthree_intro);
-----------------
--------------------

missionthree_intro2 = ConvoScreen:new {
	id = "intro2",
...
missionthree_quest_template:addScreen(missionthree_intro2);

-------------

missionthree_intro3 = ConvoScreen:new {
	id = "intro3",
...
missionthree_quest_template:addScreen(missionthree_intro3);
-------------

missionthree_intro4 = ConvoScreen:new {
	id = "intro4",
...
missionthree_quest_template:addScreen(missionthree_intro4);
----------------

missionthree_intro5 = ConvoScreen:new {
  id = "intro5",
...
missionthree_quest_template:addScreen(missionthree_intro5);
----------------


missionthree_intro6 = ConvoScreen:new {
  id = "intro6",
...
missionthree_quest_template:addScreen(missionthree_intro6);

missionthree_intro7 = ConvoScreen:new {
  id = "intro7",
...
missionthree_quest_template:addScreen(missionthree_intro7);

missionthree_intro8 = ConvoScreen:new {
  id = "intro8",
...
missionthree_quest_template:addScreen(missionthree_intro8);

missionthree_bye = ConvoScreen:new {
  id = "bye",
  customDialogText = "Goodbye.",
  stopConversation = "true",
  options = {}
}
missionthree_quest_template:addScreen(missionthree_bye);

missionthree_bye2 = ConvoScreen:new {
  id = "bye2",
  customDialogText = "Luck.",
  stopConversation = "true",
  options = {}
}
missionthree_quest_template:addScreen(missionthree_bye2);

missionthree_bye3 = ConvoScreen:new {
  id = "bye3",
  customDialogText = "Come back if you change your mind.",
  stopConversation = "true",
  options = {}
}
missionthree_quest_template:addScreen(missionthree_bye3);

missionthree_quest_accept_quest = ConvoScreen:new {
	id = "accept_quest",
	customDialogText = "Good luck. And may the Force guide you.",
	stopConversation = "true",
	options = {}
}
missionthree_quest_template:addScreen(missionthree_quest_accept_quest);

missionthree_quest_quest_status = ConvoScreen:new {
	id = "quest_status",
	customDialogText = "",
	stopConversation = "true",
	options = {}
}
missionthree_quest_template:addScreen(missionthree_quest_quest_status);

missionthree_quest_not_yet= ConvoScreen:new {
	id = "not_yet",
...
missionthree_quest_template:addScreen(missionthree_quest_not_yet);

missionthree_quest_thank_you = ConvoScreen:new {
	id = "thank_you",
	customDialogText = "I will remember what you have done for me. Keep this present as a token of my sincere gratitude.",
	stopConversation = "true",
	options = {}
}
missionthree_quest_template:addScreen(missionthree_quest_thank_you);

missionthree_quest_completed = ConvoScreen:new {
	id = "completed",
	customDialogText = "I feel that you managed to defeat Darth Caedus! You came to my brother ...",
	stopConversation = "true",
	options = {}
}
missionthree_quest_template:addScreen(missionthree_quest_completed);

missionthree_quest_reset = ConvoScreen:new {
	id = "quest_reset",
	customDialogText = "Come back if you change your mind ...",
	stopConversation = "true",
	options = {}
}
missionthree_quest_template:addScreen(missionthree_quest_reset);

----- There is no place in the inventory to give the reward ---
missionthree_no_space = ConvoScreen:new {
  id = "no_space",
  customDialogText = "It seems as if you have to make room in your inventory before receiving your reward.",
  stopConversation = "true",
  options = {}
}
missionthree_quest_template:addScreen(missionthree_no_space);

addConversationTemplate("missionthree_quest_template", missionthree_quest_template);
