missionseven_quest_template = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "missionseven_quest_convo_handler",
	screens = {}
}


missionseven_start_quest = ConvoScreen:new {
	id = "start",
...
missionseven_quest_template:addScreen(missionseven_start_quest);
-----------------

missionseven_intro = ConvoScreen:new {
	id = "intro",
...
missionseven_quest_template:addScreen(missionseven_intro);
-----------------
--------------------

missionseven_intro2 = ConvoScreen:new {
	id = "intro2",
...
missionseven_quest_template:addScreen(missionseven_intro2);

-------------

missionseven_intro3 = ConvoScreen:new {
	id = "intro3",
...
missionseven_quest_template:addScreen(missionseven_intro3);
-------------

missionseven_intro4 = ConvoScreen:new {
	id = "intro4",
...
missionseven_quest_template:addScreen(missionseven_intro4);
----------------

missionseven_intro5 = ConvoScreen:new {
  id = "intro5",
...
missionseven_quest_template:addScreen(missionseven_intro5);
----------------


missionseven_intro6 = ConvoScreen:new {
  id = "intro6",
...
missionseven_quest_template:addScreen(missionseven_intro6);

missionseven_intro7 = ConvoScreen:new {
  id = "intro7",
...
missionseven_quest_template:addScreen(missionseven_intro7);

missionseven_intro8 = ConvoScreen:new {
  id = "intro8",
...
missionseven_quest_template:addScreen(missionseven_intro8);

missionseven_bye = ConvoScreen:new {
  id = "bye",
  customDialogText = "Goodbye.",
  stopConversation = "true",
  options = {}
}
missionseven_quest_template:addScreen(missionseven_bye);

missionseven_bye2 = ConvoScreen:new {
  id = "bye2",
  customDialogText = "Luck.",
  stopConversation = "true",
  options = {}
}
missionseven_quest_template:addScreen(missionseven_bye2);

missionseven_bye3 = ConvoScreen:new {
  id = "bye3",
  customDialogText = "Come back if you change your mind.",
  stopConversation = "true",
  options = {}
}
missionseven_quest_template:addScreen(missionseven_bye3);

missionseven_quest_accept_quest = ConvoScreen:new {
	id = "accept_quest",
	customDialogText = "Good luck. And may the Force guide you.",
	stopConversation = "true",
	options = {}
}
missionseven_quest_template:addScreen(missionseven_quest_accept_quest);

missionseven_quest_quest_status = ConvoScreen:new {
	id = "quest_status",
	customDialogText = "",
	stopConversation = "true",
	options = {}
}
missionseven_quest_template:addScreen(missionseven_quest_quest_status);

missionseven_quest_not_yet= ConvoScreen:new {
	id = "not_yet",
...
missionseven_quest_template:addScreen(missionseven_quest_not_yet);

missionseven_quest_thank_you = ConvoScreen:new {
	id = "thank_you",
	customDialogText = "I will remember what you have done for me. Keep this present as a token of my sincere gratitude.",
	stopConversation = "true",
	options = {}
}
missionseven_quest_template:addScreen(missionseven_quest_thank_you);

missionseven_quest_completed = ConvoScreen:new {
	id = "completed",
	customDialogText = "I feel that you managed to defeat Darth Caedus! You came to my brother ...",
	stopConversation = "true",
	options = {}
}
missionseven_quest_template:addScreen(missionseven_quest_completed);

missionseven_quest_reset = ConvoScreen:new {
	id = "quest_reset",
	customDialogText = "Come back if you change your mind ...",
	stopConversation = "true",
	options = {}
}
missionseven_quest_template:addScreen(missionseven_quest_reset);

----- There is no place in the inventory to give the reward ---
missionseven_no_space = ConvoScreen:new {
  id = "no_space",
  customDialogText = "It seems as if you have to make room in your inventory before receiving your reward.",
  stopConversation = "true",
  options = {}
}
missionseven_quest_template:addScreen(missionseven_no_space);

addConversationTemplate("missionseven_quest_template", missionseven_quest_template);
