missionfive_quest_template = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "missionfive_quest_convo_handler",
	screens = {}
}


missionfive_start_quest = ConvoScreen:new {
	id = "start",
...
missionfive_quest_template:addScreen(missionfive_start_quest);
-----------------

missionfive_intro = ConvoScreen:new {
	id = "intro",
...
missionfive_quest_template:addScreen(missionfive_intro);
-----------------
--------------------

missionfive_intro2 = ConvoScreen:new {
	id = "intro2",
...
missionfive_quest_template:addScreen(missionfive_intro2);

-------------

missionfive_intro3 = ConvoScreen:new {
	id = "intro3",
...
missionfive_quest_template:addScreen(missionfive_intro3);
-------------

missionfive_intro4 = ConvoScreen:new {
	id = "intro4",
...
missionfive_quest_template:addScreen(missionfive_intro4);
----------------

missionfive_intro5 = ConvoScreen:new {
  id = "intro5",
...
missionfive_quest_template:addScreen(missionfive_intro5);
----------------


missionfive_intro6 = ConvoScreen:new {
  id = "intro6",
...
missionfive_quest_template:addScreen(missionfive_intro6);

missionfive_intro7 = ConvoScreen:new {
  id = "intro7",
...
missionfive_quest_template:addScreen(missionfive_intro7);

missionfive_intro8 = ConvoScreen:new {
  id = "intro8",
...
missionfive_quest_template:addScreen(missionfive_intro8);

missionfive_bye = ConvoScreen:new {
  id = "bye",
  customDialogText = "Goodbye.",
  stopConversation = "true",
  options = {}
}
missionfive_quest_template:addScreen(missionfive_bye);

missionfive_bye2 = ConvoScreen:new {
  id = "bye2",
  customDialogText = "Luck.",
  stopConversation = "true",
  options = {}
}
missionfive_quest_template:addScreen(missionfive_bye2);

missionfive_bye3 = ConvoScreen:new {
  id = "bye3",
  customDialogText = "Come back if you change your mind.",
  stopConversation = "true",
  options = {}
}
missionfive_quest_template:addScreen(missionfive_bye3);

missionfive_quest_accept_quest = ConvoScreen:new {
	id = "accept_quest",
	customDialogText = "Good luck. And may the Force guide you.",
	stopConversation = "true",
	options = {}
}
missionfive_quest_template:addScreen(missionfive_quest_accept_quest);

missionfive_quest_quest_status = ConvoScreen:new {
	id = "quest_status",
	customDialogText = "",
	stopConversation = "true",
	options = {}
}
missionfive_quest_template:addScreen(missionfive_quest_quest_status);

missionfive_quest_not_yet= ConvoScreen:new {
	id = "not_yet",
...
missionfive_quest_template:addScreen(missionfive_quest_not_yet);

missionfive_quest_thank_you = ConvoScreen:new {
	id = "thank_you",
	customDialogText = "I will remember what you have done for me. Keep this present as a token of my sincere gratitude.",
	stopConversation = "true",
	options = {}
}
missionfive_quest_template:addScreen(missionfive_quest_thank_you);

missionfive_quest_completed = ConvoScreen:new {
	id = "completed",
	customDialogText = "I feel that you managed to defeat Darth Caedus! You came to my brother ...",
	stopConversation = "true",
	options = {}
}
missionfive_quest_template:addScreen(missionfive_quest_completed);

missionfive_quest_reset = ConvoScreen:new {
	id = "quest_reset",
	customDialogText = "Come back if you change your mind ...",
	stopConversation = "true",
	options = {}
}
missionfive_quest_template:addScreen(missionfive_quest_reset);

----- There is no place in the inventory to give the reward ---
missionfive_no_space = ConvoScreen:new {
  id = "no_space",
  customDialogText = "It seems as if you have to make room in your inventory before receiving your reward.",
  stopConversation = "true",
  options = {}
}
missionfive_quest_template:addScreen(missionfive_no_space);

addConversationTemplate("missionfive_quest_template", missionfive_quest_template);
