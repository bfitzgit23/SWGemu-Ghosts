missionsix_quest_template = ConvoTemplate:new {
	initialScreen = "start",
	templateType = "Lua",
	luaClassHandler = "missionsix_quest_convo_handler",
	screens = {}
}


missionsix_start_quest = ConvoScreen:new {
	id = "start",
...
missionsix_quest_template:addScreen(missionsix_start_quest);
-----------------

missionsix_intro = ConvoScreen:new {
	id = "intro",
...
missionsix_quest_template:addScreen(missionsix_intro);
-----------------
--------------------

missionsix_intro2 = ConvoScreen:new {
	id = "intro2",
...
missionsix_quest_template:addScreen(missionsix_intro2);

-------------

missionsix_intro3 = ConvoScreen:new {
	id = "intro3",
...
missionsix_quest_template:addScreen(missionsix_intro3);
-------------

missionsix_intro4 = ConvoScreen:new {
	id = "intro4",
...
missionsix_quest_template:addScreen(missionsix_intro4);
----------------

missionsix_intro5 = ConvoScreen:new {
  id = "intro5",
...
missionsix_quest_template:addScreen(missionsix_intro5);
----------------


missionsix_intro6 = ConvoScreen:new {
  id = "intro6",
...
missionsix_quest_template:addScreen(missionsix_intro6);

missionsix_intro7 = ConvoScreen:new {
  id = "intro7",
...
missionsix_quest_template:addScreen(missionsix_intro7);

missionsix_intro8 = ConvoScreen:new {
  id = "intro8",
...
missionsix_quest_template:addScreen(missionsix_intro8);

missionsix_bye = ConvoScreen:new {
  id = "bye",
  customDialogText = "Goodbye.",
  stopConversation = "true",
  options = {}
}
missionsix_quest_template:addScreen(missionsix_bye);

missionsix_bye2 = ConvoScreen:new {
  id = "bye2",
  customDialogText = "Luck.",
  stopConversation = "true",
  options = {}
}
missionsix_quest_template:addScreen(missionsix_bye2);

missionsix_bye3 = ConvoScreen:new {
  id = "bye3",
  customDialogText = "Come back if you change your mind.",
  stopConversation = "true",
  options = {}
}
missionsix_quest_template:addScreen(missionsix_bye3);

missionsix_quest_accept_quest = ConvoScreen:new {
	id = "accept_quest",
	customDialogText = "Good luck. And may the Force guide you.",
	stopConversation = "true",
	options = {}
}
missionsix_quest_template:addScreen(missionsix_quest_accept_quest);

missionsix_quest_quest_status = ConvoScreen:new {
	id = "quest_status",
	customDialogText = "",
	stopConversation = "true",
	options = {}
}
missionsix_quest_template:addScreen(missionsix_quest_quest_status);

missionsix_quest_not_yet= ConvoScreen:new {
	id = "not_yet",
...
missionsix_quest_template:addScreen(missionsix_quest_not_yet);

missionsix_quest_thank_you = ConvoScreen:new {
	id = "thank_you",
	customDialogText = "I will remember what you have done for me. Keep this present as a token of my sincere gratitude.",
	stopConversation = "true",
	options = {}
}
missionsix_quest_template:addScreen(missionsix_quest_thank_you);

missionsix_quest_completed = ConvoScreen:new {
	id = "completed",
	customDialogText = "I feel that you managed to defeat Darth Caedus! You came to my brother ...",
	stopConversation = "true",
	options = {}
}
missionsix_quest_template:addScreen(missionsix_quest_completed);

missionsix_quest_reset = ConvoScreen:new {
	id = "quest_reset",
	customDialogText = "Come back if you change your mind ...",
	stopConversation = "true",
	options = {}
}
missionsix_quest_template:addScreen(missionsix_quest_reset);

----- There is no place in the inventory to give the reward ---
missionsix_no_space = ConvoScreen:new {
  id = "no_space",
  customDialogText = "It seems as if you have to make room in your inventory before receiving your reward.",
  stopConversation = "true",
  options = {}
}
missionsix_quest_template:addScreen(missionsix_no_space);

addConversationTemplate("missionsix_quest_template", missionsix_quest_template);
