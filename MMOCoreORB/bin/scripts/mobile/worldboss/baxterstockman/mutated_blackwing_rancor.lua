mutated_blackwing_rancor = Creature:new {
	customName = "Mutated Blackwing Rancor",
...
CreatureTemplates:addCreatureTemplate(mutated_blackwing_rancor, "mutated_blackwing_rancor")