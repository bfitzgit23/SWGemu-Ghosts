mutated_spiderclan_consort = Creature:new {
	customName = "Mutated Consort",
...
CreatureTemplates:addCreatureTemplate(mutated_spiderclan_consort, "mutated_spiderclan_consort")