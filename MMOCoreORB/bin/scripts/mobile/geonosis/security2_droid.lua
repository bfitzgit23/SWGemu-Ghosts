security2_droid = Creature:new {
	...
	diet = NONE,
	scale = 1.0,
	templates = {"object/mobile/endor_ig88_security_battledroid_purple.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(security2_droid, "security2_droid")
