security3_droid = Creature:new {
	...
	diet = NONE,
	scale = 1.0,
	templates = {"object/mobile/endor_ig88_security_battledroid_red.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(security3_droid, "security3_droid")
