security5_droid = Creature:new {
	...
	diet = NONE,
	scale = 1.0,
	templates = {"object/mobile/naboo_stonewall_labs_battledroid_yellow.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(security5_droid, "security5_droid")
