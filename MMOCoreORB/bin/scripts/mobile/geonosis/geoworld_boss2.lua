geoworld_boss2 = Creature:new {
	...
	baseHAMmax = 1000000,
	armor = 3,
	resists = {180,180,180,180,180,180,140,180,160},--kinetic,energy,blast,heat,cold,electric,acid,stun,ls
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(geoworld_boss2, "geoworld_boss2")
