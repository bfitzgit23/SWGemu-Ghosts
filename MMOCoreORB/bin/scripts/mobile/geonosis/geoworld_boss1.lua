geoworld_boss1 = Creature:new {
	...
	baseHAMmax = 1000000,
	armor = 3,
	resists = {180,180,180,180,180,180,180,140,160},--kinetic,energy,blast,heat,cold,electric,acid,stun,ls
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
	...
	scale = 3.0,
	templates = {
		"object/mobile/beast_master/bm_mutated_acklay.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(geoworld_boss1, "geoworld_boss1")
