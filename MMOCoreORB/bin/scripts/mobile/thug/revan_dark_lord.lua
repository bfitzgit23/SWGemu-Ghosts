...
-- Revan Dark Lord
-- Phase 3 Final Trial for Dark Jedi players (75% stronger than Phase 1)
-- Double tier loot drops

revan_dark_lord = Creature:new {
	customName = "Revan - Dark Jedi Lord",
...
CreatureTemplates:addCreatureTemplate(revan_dark_lord, "revan_dark_lord")
