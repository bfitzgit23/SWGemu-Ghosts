...
-- Revan Grand Master Novice
-- Phase 1 Master Trial for Light Jedi players
-- Level 300 - solo challenge for a geared Knight

revan_grand_master_novice = Creature:new {
	customName = "Revan - Grand Master Novice",
...
CreatureTemplates:addCreatureTemplate(revan_grand_master_novice, "revan_grand_master_novice")
