...
function mokk_worldboss_sp:KillSpawnCast3(bossObject)
		local boss = LuaCreatureObject(bossObject)
		CreatureObject(bossObject):broadcastToServer("\\#63C8F9 Mokk Chieftain Boss Respawning.")
		CreatureObject(bossObject):broadcastToDiscord("Mokk Chieftain Boss Respawning.")
end
