...
function isd_active_areas:notifySpawnArea1(pActiveArea1, pMovingObject, pPlayer)
  ...
  if (not SceneObject(pMovingObject):isPlayerCreature()) then
    return 0
      ...
      CreatureObject(pMovingObject):playMusicMessage("sound/mus_isd_hangar.snd")       
  end
  return 0  
end
...
function isd_active_areas:notifySpawnArea2(pActiveArea2, pMovingObject, pPlayer)
  ...
  if (not SceneObject(pMovingObject):isPlayerCreature()) then
    return 0
      ...
      CreatureObject(pMovingObject):playMusicMessage("sound/mus_isd_briefing.snd")              
  end
  return 0 
end
...
function republic_corvette:notifySpawnArea3(pActiveArea3, pMovingObject, pPlayer)
  ...
  if (not SceneObject(pMovingObject):isPlayerCreature()) then
    return 0
      ...
      CreatureObject(pMovingObject):playMusicMessage("sound/mus_isd_hangar2.snd")      
  end
  return 0  
end
