...
function MandaloreScreenPlay:spawnMobiles()
	...
	spawnMobile("mandalore", "at_at",600,6542.2,1.2,-4759.4,52,0)
	spawnMobile("mandalore", "imperial_recruiter",60,6508.0,0.9,-4725.5,-58,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6659.2,0.3,-4813.9,119,0)
	spawnMobile("mandalore", "imperial_clone_trooper_general",600,6560.9,0.4,-4809.1,38,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6556.8,0.4,-4812.2,-123,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6511.7,0.7,-4826.0,-179,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6488.7,1.6,-4826.0,-179,0)
	spawnMobile("mandalore", "imperial_clone_trooper_general",600,6438.1,2.5,-4810.3,-126,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6435.7,1.1,-4805.4,-24,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6433.4,7.0,-4683.0,-50,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6487.8,6.1,-4675.0,0,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6512.1,5.1,-4675.0,0,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6562.3,0.3,-4684.6,58,0)
	spawnMobile("mandalore", "imperial_clone_trooper_general",600,6553.5,1.4,-4683.3,-67,0)
	spawnMobile("mandalore", "imperial_clone_trooper",600,6555.3,0.9,-4689.4,-147,0)
	spawnMobile("mandalore", "imperial_clone_trooper_general",600,6521.0,3.0,-4700.5,-28,0)
	spawnMobile("mandalore", "at_st",600,6476.7,5.5,-4693.2,35,0)
	spawnMobile("mandalore", "imperial_clone_trooper_general",600,6485.5,0.3,-4797.2,171,0)
	spawnMobile("mandalore", "at_st",600,6501.1,1.1,-4796.4,-166,0)
