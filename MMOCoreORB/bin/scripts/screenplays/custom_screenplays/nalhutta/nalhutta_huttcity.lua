...
NalHuttaCityScreenPlay = ScreenPlay:new {
	numberOfActs = 1,

	screenplayName = "NalHuttaCityScreenPlay"
}

registerScreenPlay("NalHuttaCityScreenPlay", true)

function NalHuttaCityScreenPlay:start()
...
function NalHuttaCityScreenPlay:spawnSceneObjects()
...
function NalHuttaCityScreenPlay:spawnMobiles()
...
function NalHuttaCityScreenPlay:spawnActiveArea1()
...
function NalHuttaCityScreenPlay:notifySpawnArea1(pActiveArea1, pMovingObject, pPlayer)
