...
function exarKun2:spawnBossRoomOneActiveArea()  -- Active areas use world coords.   Set to actual world coord in each instance manually.
  local pActiveArea1 = spawnActiveArea("yavin4", "object/active_area.iff", -6574, 920, 1651, 15, 480000302)
...
function exarKun2:spawnBossRoomFour()
  local boss4 = spawnMobile("yavin4", "exar_kun_fist_of_hate", 0, 15.6, 0.0, 92.8, 178, 480000307)
    ...
    spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 71.4, -90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 75.4, -90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 79.4, -90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 83.4, -90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 87.4, -90, 480000307)
    
    spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 71.4, 90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 75.4, 90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 79.4, 90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 83.4, 90, 480000307)
    spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 87.4, 90, 480000307)
...
function exarKun2:boss5_damage(boss5, pPlayer)
    ...
    if ( boss ~= nil ) then
      ...
      if (((bossHealth <= (bossMaxHealth *0.50))) and readData("exarKun2:bossFiveFightState") == 2) then
        ...
        local pCult1 = spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 71.4, -90, 480000307)
          CreatureObject(pCult1):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult2 = spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 75.4, -90, 480000307)
          CreatureObject(pCult2):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult3 = spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 79.4, -90, 480000307)
          CreatureObject(pCult3):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult4 = spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 83.4, -90, 480000307)
          CreatureObject(pCult4):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult5 = spawnMobile("yavin4", "exar_kun_cultist", 0, 33.2, -0.1, 87.4, -90, 480000307)
          CreatureObject(pCult5):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        
        local pCult6 = spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 71.4, 90, 480000307)
          CreatureObject(pCult6):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult7 = spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 75.4, 90, 480000307)
          CreatureObject(pCult7):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult8 = spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 79.4, 90, 480000307)
          CreatureObject(pCult8):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult9 = spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 83.4, 90, 480000307)
          CreatureObject(pCult9):playEffect("clienteffect/pl_force_regain_consciousness_self.cef", "") 
        local pCult10 = spawnMobile("yavin4", "exar_kun_cultist", 0, -3.0, -0.1, 87.4, 90, 480000307)
