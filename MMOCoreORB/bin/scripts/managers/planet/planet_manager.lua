...
chandrila = {
	...
	gcwEnabled = 1,
	planetTravelPoints = {
		{name = "Hanna City Starport", x = 350, z = 7, y = -2900, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1, landingRange = 6},
		{name = "Nayli Outpost Shuttleport", x = -5255, z = 23, y = 345, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1, landingRange = 3},
	},
	badgeAreas = {},
	planetObjects = {},
}
