object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_gen6 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_two_hand_gen5:new {
	templateType = DRAFTSCHEMATIC,
	customObjectName = "Two-Handed Sixth Generation Lightsaber",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_gen6, "object/draft_schematic/weapon/lightsaber/lightsaber_two_hand_gen6.iff")
