object_weapon_ranged_carbine_carbine_underslung_blast = object_weapon_ranged_carbine_shared_carbine_underslung_blast:new {
...
ObjectTemplates: addTemplate(object_weapon_ranged_carbine_carbine_underslung_blast, "object/weapon/ranged/carbine/carbine_underslung_blast.iff")