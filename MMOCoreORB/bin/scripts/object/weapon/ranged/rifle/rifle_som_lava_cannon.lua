...
object_weapon_ranged_rifle_rifle_som_lava_cannon = object_weapon_ranged_rifle_shared_rifle_som_lava_cannon:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_som_lava_cannon, "object/weapon/ranged/rifle/rifle_som_lava_cannon.iff")
