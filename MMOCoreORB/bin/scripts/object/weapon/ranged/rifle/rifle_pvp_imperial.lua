...
object_weapon_ranged_rifle_rifle_pvp_imperial = object_weapon_ranged_rifle_shared_rifle_pvp_imperial:new {
	...
	skillRequired = "combat_commando_master",
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_pvp_imperial, "object/weapon/ranged/rifle/rifle_pvp_imperial.iff")
