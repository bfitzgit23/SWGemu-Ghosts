...
object_weapon_ranged_rifle_rifle_carbonite_cold_rifle = object_weapon_ranged_rifle_shared_rifle_carbonite_cold_rifle:new {
...
ObjectTemplates:addTemplate(object_weapon_ranged_rifle_rifle_carbonite_cold_rifle, "object/weapon/ranged/rifle/rifle_carbonite_cold_rifle.iff")
