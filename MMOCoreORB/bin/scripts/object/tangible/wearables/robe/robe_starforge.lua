...
-- Starforge Robe - awarded to Grand Jedi Master novice on Phase 1 Revan kill
-- Stat mods: force control/power/manipulation light 25, force regen 25, force max 500
-- 8 sockets
...
object_tangible_wearables_robe_robe_starforge = object_tangible_wearables_robe_shared_robe_starforge:new {
	...
	-- Skill mods: Grand Jedi Master novice robe
	skillMods = {
	...
	experimentalMin = {0, 0, 8, 1000},
	experimentalMax = {0, 0, 8, 1000},
