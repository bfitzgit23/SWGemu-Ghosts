...
-- Revan Robe - awarded to Dark Jedi Lord novice on Phase 1 Revan kill
-- Stat mods: force control/power/manipulation dark 25, force regen 25, force max 500
-- 8 sockets
...
object_tangible_wearables_robe_robe_revan = object_tangible_wearables_robe_shared_robe_revan:new {
	...
	-- Skill mods: Dark Jedi Lord novice robe
	skillMods = {
