...
object_tangible_wearables_backpack_backpack_salvation = object_tangible_wearables_backpack_shared_backpack_salvation:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_backpack_backpack_salvation, "object/tangible/wearables/backpack/backpack_salvation.iff")
