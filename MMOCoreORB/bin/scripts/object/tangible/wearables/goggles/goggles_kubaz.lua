...
object_tangible_wearables_goggles_goggles_kubaz = object_tangible_wearables_goggles_shared_goggles_kubaz:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_goggles_goggles_kubaz, "object/tangible/wearables/goggles/goggles_kubaz.iff")
