...
object_tangible_wearables_armor_invisible_invisible_helmet = object_tangible_wearables_armor_invisible_shared_invisible_helmet:new {
	templateType = ARMOROBJECT,

	customName = "Invisible Generic Armor Helmet",
...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_invisible_invisible_helmet, "object/tangible/wearables/armor/invisible/invisible_helmet.iff")
