...
object_tangible_wearables_armor_spy_armor_spy_belt = object_tangible_wearables_armor_spy_shared_armor_spy_belt:new {
		templateType = ARMOROBJECT,
				certificationsRequired = {"combat_spy_attacks_04"},
	...
	experimentalMin = {0, 0, 1000, 10, 15000, 0, 0, 0, 1, 2, 10, 15000},
	experimentalMax = {0, 0, 10000, 50, 25000, 0, 0, 0, 1, 2, 70, 25000},
