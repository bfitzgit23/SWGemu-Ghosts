...
object_tangible_wearables_bodysuit_bodysuit_prisoner = object_tangible_wearables_bodysuit_shared_bodysuit_prisoner:new {
...
ObjectTemplates:addTemplate(object_tangible_wearables_bodysuit_bodysuit_prisoner, "object/tangible/wearables/bodysuit/bodysuit_prisoner.iff")
