...
//	int uncappedLevel = level;
	...
	float excMod = 2.5;//+ (System::random(100) / 100);//was 15/10
	...
	if ((prototype->isComponent() || prototype->isWeaponObject() || prototype->isArmorObject()) && !prototype->isLightsaberCrystalObject()) {

		if (System::random(newlegendaryChance) >= newlegendaryChance) {
