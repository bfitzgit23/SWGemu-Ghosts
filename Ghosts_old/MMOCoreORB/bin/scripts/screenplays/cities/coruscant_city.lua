...
function CoruscantCityScreenPlay:spawnSceneObjects()
	...
	spawnSceneObject(self.planet, "object/tangible/terminal/terminal_ticket_collector.iff", -1849, 40, -175, 0, math.rad(0))
	...
	spawnSceneObject(self.planet, "object/tangible/terminal/terminal_ticket_collector.iff", 1540, 40, 779, 0, math.rad(0))
	...
	spawnSceneObject(self.planet, "object/tangible/terminal/terminal_ticket_collector.iff", 2250, 0, -4546, 0, math.rad(0))
	...
	spawnSceneObject(self.planet, "object/tangible/terminal/terminal_ticket_collector.iff", -26, 40, 3202, 0, math.rad(0))
	...
	spawnSceneObject(self.planet, "object/tangible/terminal/terminal_ticket_collector.iff", -94, 40, 3149, 0, math.rad(0))
end
