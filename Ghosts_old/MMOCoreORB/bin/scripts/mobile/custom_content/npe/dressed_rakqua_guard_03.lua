dressed_rakqua_guard_03 = Creature:new {
	...
	templates = {"object/mobile/npe/dressed_rakqua_guard_03.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(dressed_rakqua_guard_03, "dressed_rakqua_guard_03")
