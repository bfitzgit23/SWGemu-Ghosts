dressed_rakqua_guard_01 = Creature:new {
	customName = "Rakqua Guard",
	randomNameTag = true,
	socialGroup = "rakqua",
	faction = "",
	level = 200,
	...
	templates = {"object/mobile/npe/dressed_rakqua_guard_01.iff"},
	lootGroups = {
		{
			groups = {
	...
	attacks = merge(fencermid,swordsmanmid,tkamid,brawlermaster)
}

CreatureTemplates:addCreatureTemplate(dressed_rakqua_guard_01, "dressed_rakqua_guard_01")
