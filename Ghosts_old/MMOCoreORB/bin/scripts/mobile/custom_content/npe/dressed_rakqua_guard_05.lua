dressed_rakqua_guard_05 = Creature:new {
	...
	templates = {"object/mobile/npe/dressed_rakqua_guard_05.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(dressed_rakqua_guard_05, "dressed_rakqua_guard_05")
