dressed_rakqua_guard_04 = Creature:new {
	...
	templates = {"object/mobile/npe/dressed_rakqua_guard_04.iff"},
	lootGroups = {
		{
			groups = {
...
CreatureTemplates:addCreatureTemplate(dressed_rakqua_guard_04, "dressed_rakqua_guard_04")
